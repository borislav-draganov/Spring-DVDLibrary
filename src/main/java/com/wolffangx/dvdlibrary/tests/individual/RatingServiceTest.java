...
/**
 * The Rating ReST Web Service Unit Test
...
public class RatingServiceTest {
    private static String resType = "ratings/";
    ...
    public static int insertNewEntry(ContentType type, String name, int expectedCode) {
        ...
        // The new valid entry
        Rating validRating = new Rating(name);
        ...
        if (name != null) {
            String newId = // Get the ID of the newly added entry
                    given().
                            ...
                            body(validRating).                              // Supply the data
                    when().
    ...
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Try to insert an invalid Rating object
     *
     * @param type - JSON or XML
     */
    ...
    public static void updateEntryById(ContentType type, int id, String newName, int expectedCode) {
        ...
        // The new valid entry
        Rating validRating = new Rating(newName);
