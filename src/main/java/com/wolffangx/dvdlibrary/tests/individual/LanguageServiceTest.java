...
/**
 * The Language ReST Web Service Unit Test
...
public class LanguageServiceTest {
    private static String resType = "languages/";
    ...
    public static int insertNewEntry(ContentType type, String name, int expectedCode) {
        ...
        // The new valid entry
        Language validLanguage = new Language(name);
        ...
        if (name != null) {
            String newId = // Get the ID of the newly added entry
                    given().
                            ...
                            body(validLanguage).                            // Supply the data
                    when().
    ...
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Insert a valid Language object
     *
     * @param type - JSON or XML
     */
    ...
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Try to insert an invalid Language object
     *
     * @param type - JSON or XML
     */
    ...
    public static void updateEntryById(ContentType type, int id, String newName, int expectedCode) {
        ...
        // The new valid entry
        Language validLanguage = new Language(newName);
