...
/**
 * The Movie ReST Web Service Unit Test
...
public class MovieServiceTest {
    private static String resType = "movies/";

    private static String validationFieldName = "title";
    ...
    public static int insertNewEntry(ContentType type, String name, int expectedCode) {
        ...
        // The new valid entry
        Movie validMovie = TestUtil.generateValidMovie(name);
        ...
        if (name != null) {
            String newId = // Get the ID of the newly added entry
                    given().
                            ...
                            body(validMovie).                               // Supply the data
                    when().
    ...
    public static void insertValidObject(ContentType type) {
        try {
            ...
            // Clean Up (Remove the temporary Rating and Genre entries)
            TestUtil.cleanUpMovieTemps();
        }
    }
    ...
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Try to insert an invalid Movie object
     *
     * @param type - JSON or XML
     */
