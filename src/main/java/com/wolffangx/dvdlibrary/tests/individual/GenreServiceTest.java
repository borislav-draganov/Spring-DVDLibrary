...
/**
 * The Genre ReST Web Service Unit Test
...
public class GenreServiceTest {
    private static String resType = "genres/";
    ...
    public static int insertNewEntry(ContentType type, String name, int expectedCode) {
        ...
        // The new valid entry
        Genre validGenre = new Genre(name);
        ...
        if (name != null) {
            String newId = // Get the ID of the newly added entry
                    given().
                            ...
                            body(validGenre).                               // Supply the data
                    when().
    ...
    //-----------------------------------------------------------------------------------------------------------------
    /**
     * Try to insert an invalid Genre object
     *
     * @param type - JSON or XML
     */
    ...
    public static void updateEntryById(ContentType type, int id, String newName, int expectedCode) {
        ...
        // The new valid entry
        Genre validGenre = new Genre(newName);
