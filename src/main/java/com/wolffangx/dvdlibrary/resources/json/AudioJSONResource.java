...
/**
 * Exposed Audio JSON Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("json/audios")
public class AudioJSONResource extends AudioRes {
    /**
     ...
     *
     * @param audio - JSON Serialized object to be inserted into the database
