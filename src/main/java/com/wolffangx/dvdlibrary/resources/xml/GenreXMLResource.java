...
/**
 * Exposed Genre XML Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("xml/genres")
public class GenreXMLResource extends GenreRes {
    /**
     ...
     *
     * @param genre - XML Serialized object to be inserted into the database
