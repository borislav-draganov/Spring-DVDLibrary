...
/**
 * Exposed Language XML Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("xml/languages")
public class LanguageXMLResource extends LanguageRes {
    /**
     ...
     *
     * @param language - XML Serialized object to be inserted into the database
