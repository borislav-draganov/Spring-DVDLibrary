...
/**
 * Exposed Rating XML Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("xml/ratings")
public class RatingXMLResource extends RatingRes {
    /**
     ...
     *
     * @param rating - XML Serialized object to be inserted into the database
