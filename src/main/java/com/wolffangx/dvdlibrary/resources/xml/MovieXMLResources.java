...
/**
 * Exposed Movie XML Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("xml/movies")
public class MovieXMLResources extends MovieRes {
    /**
     ...
     *
     * @param movie - XML Serialized object to be inserted into the database
