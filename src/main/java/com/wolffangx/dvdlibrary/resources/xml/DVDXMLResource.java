...
/**
 * Exposed DVD XML Web Services
 *
 * @author borislav.draganov
 */

@RestController
@RequestMapping("xml/dvds")
public class DVDXMLResource extends DVDRes {
    /**
     ...
     * @return - A ResponseEntity with a List of DVD objects
     */
    @RequestMapping(value = "rating/{rating}", method = RequestMethod.GET, produces = MediaType.APPLICATION_XML_VALUE)
     ...
     */
    @RequestMapping(value = "rating/{rating}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_XML_VALUE)
     ...
     * @return - A ResponseEntity with a List of DVD objects
     */
    @RequestMapping(value = "language/{language}/audio/{audio}", method = RequestMethod.GET, produces = MediaType.APPLICATION_XML_VALUE)
     ...
     * @return - A ResponseEntity with either a success message or an error message
     */
    @RequestMapping(value = "language/{language}/audio/{audio}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_XML_VALUE)
     ...
     *
     * @param dvd - XML Serialized object to be inserted into the database
